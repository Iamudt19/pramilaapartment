          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-300 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 focus:outline-none focus:border-blue-700 focus:bg-white transition-colors"
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-2.5">
                    <div className={`p-1.5 rounded-xl ${isSelected ? 'bg-blue-900 text-white' : 'bg-slate-200 text-slate-600'}`}>

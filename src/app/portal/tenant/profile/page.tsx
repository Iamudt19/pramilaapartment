...
import { FolderLock, ShieldCheck, User, Phone, Mail, Upload, Plus } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="glass-card rounded-3xl p-6 border border-slate-800 space-y-4">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-700 flex items-center justify-center font-bold text-white text-2xl shadow-lg">
      ...
      {showUploadModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-in fade-in duration-150">
          <div className="bg-slate-900 border border-slate-700 rounded-3xl max-w-md w-full p-6 shadow-2xl">
            <h3 className="text-lg font-bold text-white mb-4">Upload Document to Vault</h3>
            <form onSubmit={handleUploadDoc} className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. Registered 11-Month Lease Agreement"
                  value={newDoc.title}
